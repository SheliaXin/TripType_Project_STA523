...
To classify the visit number, we used SVM algorithm.
...
To improve our Support Vector Machine Models, we could use tuning to set our parameter `cost`, `gamma` in SVM model. 
